...
openLog 是一个移动端远程控制台工具，通过 WebSocket 实时传输移动设备的 console 日志到本地服务器，支持 PC 浏览器查看和 AI 工具直接查询。
...
```bash
export OPENLOG_API_BASE_URL=http://localhost:38291/api
...
**GitHub**: https://github.com/uaio/openLog
