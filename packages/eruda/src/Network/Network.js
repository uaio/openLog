...
export default class Network extends Tool {
  ...
  init($el, container) {
    ...
    this._requestDataGrid = new LunaDataGrid(this._$requests.get(0), {
      columns: [
        {
          id: 'name',
          title: i18n.t('network.name'),
          sortable: true,
          weight: 30,
        },
        {
          id: 'method',
          title: i18n.t('network.method'),
          sortable: true,
          weight: 14,
        },
        {
          id: 'status',
          title: i18n.t('network.status'),
          sortable: true,
          weight: 14,
        },
        {
          id: 'type',
          title: i18n.t('network.type'),
          sortable: true,
          weight: 14,
        },
        {
          id: 'size',
          title: i18n.t('network.size'),
          sortable: true,
          weight: 14,
        },
        {
          id: 'time',
          title: i18n.t('network.time'),
          sortable: true,
          weight: 14,
        },
      ],
  ...
  _copyCurl = () => {
    ...
    this._container.notify(i18n.t('common.copied'), { icon: 'success' })
  }
  _updateButtons() {
